        ...
        <div className="p-5 sm:p-8">
          <div className="flex items-center justify-between mb-5 sm:mb-6">
            <div>
              ...
              <h2 className="font-['EB_Garamond',serif] text-xl sm:text-3xl font-bold text-[#1A2A2B]">House Rules</h2>
            </div>
            <button
            ...
            {highlights.map(({ icon: Icon, title, desc, color, bg }) => (
              <div key={title} className="flex items-start gap-3 bg-white rounded-xl p-4 border border-slate-100/80">
                ...
                <div className="min-w-0">
                  <h3 className="font-['EB_Garamond',serif] text-sm font-bold text-[#1A2A2B] mb-0.5">{title}</h3>
