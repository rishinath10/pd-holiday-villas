  ...
  return (
    <div className="px-3 sm:px-6 lg:px-8 max-w-4xl mx-auto py-8 sm:py-12">
      <div className="bg-white rounded-3xl p-6 sm:p-10 shadow-soft border border-slate-100">
        ...
        <h1 className="font-['Cormorant_Garamond',serif] text-3xl sm:text-4xl font-bold text-[#1A2A2B] mb-6">Terms & Conditions</h1>
        <p className="text-sm text-slate-500 mb-8">Last updated: August 2026</p>

        <div className="space-y-6 text-sm text-slate-600 leading-relaxed">
          <section>
            <h2 className="font-['Cormorant_Garamond',serif] text-xl font-bold text-[#1A2A2B] mb-2">1. Booking & Confirmation</h2>
          ...
          <section>
            <h2 className="font-['Cormorant_Garamond',serif] text-xl font-bold text-[#1A2A2B] mb-2">2. Check-in & Check-out</h2>
          ...
          <section>
            <h2 className="font-['Cormorant_Garamond',serif] text-xl font-bold text-[#1A2A2B] mb-2">3. Security Deposit</h2>
          ...
          <section>
            <h2 className="font-['Cormorant_Garamond',serif] text-xl font-bold text-[#1A2A2B] mb-2">4. Cancellation Policy</h2>
          ...
          <section>
            <h2 className="font-['Cormorant_Garamond',serif] text-xl font-bold text-[#1A2A2B] mb-2">5. Guest Responsibilities</h2>
          ...
          <section>
            <h2 className="font-['Cormorant_Garamond',serif] text-xl font-bold text-[#1A2A2B] mb-2">6. Liability</h2>
          ...
          <section>
            <h2 className="font-['Cormorant_Garamond',serif] text-xl font-bold text-[#1A2A2B] mb-2">7. Pricing</h2>
