    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="contact-modal-title">
      ...
      <div className="relative w-full max-w-md bg-[#FFF9F5] rounded-3xl shadow-2xl overflow-hidden animate-modal-slide-up">
        ...
        <div className="p-5 space-y-4">
          ...
          <a href="https://wa.me/60123552585?text=Hi%20Manager%20Jeff%2C%20I%27m%20interested%20in%20booking%20a%20villa%20at%20PD%20Holiday%20Villas." target="_blank" rel="noopener noreferrer" onClick={() => trackWhatsAppClick('contact-modal')} className="block w-full py-3 rounded-2xl bg-[#25D366] hover:bg-[#128C7E] text-white font-bold text-center transition-all shadow-md">
            Chat on WhatsApp
          </a>
        </div>
      </div>
